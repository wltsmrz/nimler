...
type
  ...
  ErlNifFptr* = proc (env: ptr ErlNifEnv; argc: cint;
      argv: ErlNifArgs): ErlNifTerm {.cdecl.}
  ...
  ErlNifFunc* {.c_dep_struct.} = object
    ...
    fptr*: ErlNifFptr
    flags*: ErlNifFlags
  ErlNifEntryLoad* = proc (a1: ptr ErlNifEnv; priv_data: ptr pointer;
      load_info: ErlNifTerm): cint {.nimcall.}
  ErlNifEntryReload* = proc (a1: ptr ErlNifEnv; priv_data: ptr pointer;
      load_info: ErlNifTerm): cint {.nimcall.}
  ErlNifEntryUpgrade* = proc (a1: ptr ErlNifEnv; priv_data: ptr pointer;
      old_priv_data: ptr pointer; load_info: ErlNifTerm): cint {.nimcall.}
  ...
  ErlNifResourceStop* = proc (a1: ptr ErlNifEnv; a2: pointer; a3: ErlNifEvent;
      is_direct_call: cint): void
  ErlNifResourceDown* = proc (a1: ptr ErlNifEnv; a2: pointer; a3: ptr ErlNifPid;
      a4: ptr ErlNifMonitor): void
...
func enif_hash*(a1: ErlNifHash; term: ErlNifTerm;
    salt: culonglong = 0): culonglong {.c_dep_proc.}
...
# comparisons
func enif_term_type*(a1: ptr ErlNifEnv; a2: ErlNifTerm): ErlNifTermType {.
    c_dep_proc, minNifVersion(2, 15).}
...
# get
func enif_get_atom*(a1: ptr ErlNifEnv; a2: ErlNifTerm; a3: ptr char;
    a4: csize_t; a5: ErlNifCharEncoding): cint {.c_dep_proc.}
func enif_get_atom_length*(a1: ptr ErlNifEnv; a2: ErlNifTerm; a3: ptr cuint;
    a4: ErlNifCharEncoding): bool {.c_dep_proc.}
...
func enif_get_double*(a1: ptr ErlNifEnv; a2: ErlNifTerm;
    a3: ptr cdouble): bool {.c_dep_proc.}
func enif_get_list_cell*(a1: ptr ErlNifEnv; a2: ErlNifTerm; a3: ptr ErlNifTerm;
    a4: ptr ErlNifTerm): bool {.c_dep_proc.}
func enif_get_list_length*(a1: ptr ErlNifEnv; a2: ErlNifTerm;
    len: ptr cuint): bool {.c_dep_proc.}
func enif_get_tuple*(a1: ptr ErlNifEnv; a2: ErlNifTerm; a3: ptr cuint;
    a4: ptr ptr UncheckedArray[ErlNifTerm]): bool {.c_dep_proc.}
func enif_get_string*(a1: ptr ErlNifEnv; a2: ErlNifTerm; a3: ptr char;
    a4: csize_t; a5: ErlNifCharEncoding): cint {.c_dep_proc.}

# make
func enif_make_unique_integer*(a1: ptr ErlNifEnv;
    a2: ErlNifUniqueInteger): ErlNifTerm {.c_dep_proc.}
func enif_make_atom*(a1: ptr ErlNifEnv; a2: cstring): ErlNifTerm {.c_dep_proc.}
func enif_make_atom_len*(a1: ptr ErlNifEnv; a2: cstring;
    a3: uint): ErlNifTerm {.c_dep_proc.}
func enif_make_existing_atom*(a1: ptr ErlNifEnv; a2: cstring;
    a3: ptr ErlNifTerm; a4: ErlNifCharEncoding): bool {.c_dep_proc.}
template enif_make_existing_atom*(a1: ptr ErlNifEnv; a2: cstring;
    a3: ptr ErlNifTerm): untyped =
  enif_make_existing_atom(a1, a2, a3, ERL_NIF_LATIN1)
func enif_make_existing_atom_len*(a1: ptr ErlNifEnv; a2: cstring; a3: uint;
    a4: ptr ErlNifTerm; a5: ErlNifCharEncoding): bool {.c_dep_proc.}
template enif_make_existing_atom_len*(a1: ptr ErlNifEnv; a2: cstring; a3: uint;
    a4: ptr ErlNifTerm): untyped =
...
func enif_make_sub_binary*(a1: ptr ErlNifEnv; a2: ErlNifTerm; a3: csize_t;
    a4: csize_t): ErlNifTerm {.c_dep_proc.}
...
func enif_make_list_cell*(a1: ptr ErlNifEnv; a2: ErlNifTerm;
    a3: ErlNifTerm): ErlNifTerm {.c_dep_proc.}
func enif_make_reverse_list*(a1: ptr ErlNifEnv; a2: ErlNifTerm;
    a3: ptr ErlNifTerm): bool {.c_dep_proc.}
func enif_make_string*(a1: ptr ErlNifEnv; a2: cstring;
    a3: ErlNifCharEncoding): ErlNifTerm {.c_dep_proc.}
template enif_make_string*(a1: ptr ErlNifEnv; a2: cstring): untyped =
  enif_make_string(a1, a2, ERL_NIF_LATIN1)
func enif_make_string_len*(a1: ptr ErlNifEnv; string: cstring; a2: csize_t;
    a3: ErlNifCharEncoding): ErlNifTerm {.c_dep_proc.}
func enif_make_string_len*(a1: ptr ErlNifEnv; string: openArray[char];
    a3: ErlNifCharEncoding): ErlNifTerm {.c_dep_proc.}
...
func enif_make_tuple_from_array*(a1: ptr ErlNifEnv; a2: openArray[
    ErlNifTerm]): ErlNifTerm {.c_dep_proc.}
template enif_make_tuple_from_array*(a1: ptr ErlNifEnv; a2: array[2,
    ErlNifTerm]): ErlNifTerm =
  enif_make_tuple_from_array(a1, toOpenArray(a2, 0, 1))
func enif_make_list_from_array*(a1: ptr ErlNifEnv; a2: openArray[
    ErlNifTerm]): ErlNifTerm {.c_dep_proc.}
func enif_make_new_binary*(a1: ptr ErlNifEnv; a2: csize_t;
    a3: ptr ErlNifTerm): ptr cuchar {.c_dep_proc.}
...
# 64bit
func enif_get_int64*(a1: ptr ErlNifEnv; a2: ErlNifTerm;
    a3: ptr clonglong): bool {.c_dep_proc.}
func enif_get_uint64*(a1: ptr ErlNifEnv; a2: ErlNifTerm;
    a3: ptr culonglong): bool {.c_dep_proc.}
...
#maps
func enif_map_iterator_create*(a1: ptr ErlNifEnv; a2: ErlNifTerm;
    a3: ptr ErlNifMapIterator; a4: ErlNifMapIteratorEntry): bool {.c_dep_proc.}
func enif_map_iterator_destroy*(a1: ptr ErlNifEnv;
    a2: ptr ErlNifMapIterator): void {.c_dep_proc.}
func enif_map_iterator_next*(a1: ptr ErlNifEnv;
    a2: ptr ErlNifMapIterator): bool {.c_dep_proc.}
func enif_map_iterator_prev*(a1: ptr ErlNifEnv;
    a2: ptr ErlNifMapIterator): bool {.c_dep_proc.}
func enif_map_iterator_get_pair*(a1: ptr ErlNifEnv; a2: ptr ErlNifMapIterator;
    a3: ptr ErlNifTerm; a4: ptr ErlNifTerm): bool {.c_dep_proc.}
func enif_map_iterator_is_head*(a1: ptr ErlNifEnv;
    a2: ptr ErlNifMapIterator): bool {.c_dep_proc.}
func enif_map_iterator_is_tail*(a1: ptr ErlNifEnv;
    a2: ptr ErlNifMapIterator): bool {.c_dep_proc.}
func enif_get_map_size*(a1: ptr ErlNifEnv; a2: ErlNifTerm;
    a3: ptr csize_t): bool {.c_dep_proc.}
func enif_make_new_map*(a1: ptr ErlNifEnv): ErlNifTerm {.c_dep_proc.}
func enif_make_map_from_arrays*(a1: ptr ErlNifEnv; a2: ptr ErlNifTerm;
    a3: ptr ErlNifTerm; a4: cuint; a5: ptr ErlNifTerm): bool {.c_dep_proc,
    minNifVersion(2, 14).}
func enif_make_map_put*(a1: ptr ErlNifEnv; a2: ErlNifTerm; a3: ErlNifTerm;
    a4: ErlNifTerm; a5: ptr ErlNifTerm): bool {.c_dep_proc.}
func enif_get_map_value*(a1: ptr ErlNifEnv; a2: ErlNifTerm; a3: ErlNifTerm;
    a4: ptr ErlNifTerm): bool {.c_dep_proc.}
func enif_make_map_update*(a1: ptr ErlNifEnv; a2: ErlNifTerm; a3: ErlNifTerm;
    a4: ErlNifTerm; a5: ptr ErlNifTerm): bool {.c_dep_proc.}
func enif_make_map_remove*(a1: ptr ErlNifEnv; a2: ErlNifTerm; a3: ErlNifTerm;
    a4: ptr ErlNifTerm): bool {.c_dep_proc.}

# binaries
func enif_inspect_binary*(a1: ptr ErlNifEnv; a2: ErlNifTerm;
    a3: ptr ErlNifBinary): bool {.c_dep_proc.}
...
func enif_term_to_binary*(a1: ptr ErlNifEnv; a2: ErlNifTerm;
    a3: ptr ErlNifBinary): bool {.c_dep_proc.}
func enif_binary_to_term*(a1: ptr ErlNifEnv; a2: ptr cuchar; a3: csize_t;
    a4: ptr ErlNifTerm; a5: ErlNifBinaryToTerm): csize_t {.c_dep_proc.}
template enif_binary_to_term*(a1: ptr ErlNifEnv; a2: ptr cuchar; a3: csize_t;
    a4: ptr ErlNifTerm): untyped =
...
func enif_send*(a1: ptr ErlNifEnv; a2: ptr ErlNifPid; a3: ptr ErlNifEnv;
    a4: ErlNifTerm): bool {.c_dep_proc.}
func enif_self*(a1: ptr ErlNifEnv; a2: ptr ErlNifPid): ptr ErlNifPid {.c_dep_proc.}
func enif_get_local_pid*(a1: ptr ErlNifEnv; a2: ErlNifTerm;
    a3: ptr ErlNifPid): bool {.c_dep_proc.}

# resources
func enif_open_resource_type*(a1: ptr ErlNifEnv; a2: pointer; a3: cstring;
    a4: pointer; a5: ErlNifResourceFlags;
    a6: ptr ErlNifResourceFlags): ptr ErlNifResourceType {.c_dep_proc.}
func enif_open_resource_type*(a1: ptr ErlNifEnv; a2: pointer; a3: cstring;
    a4: pointer; a5: cint; a6: ptr cint): ptr ErlNifResourceType {.c_dep_proc.}
template enif_open_resource_type*(a1: ptr ErlNifEnv; a2: cstring; a3: cint;
    a4: ptr cint): untyped =
  enif_open_resource_type(a1, nil, a2, nil, a3, a4)
template enif_open_resource_type*(a1: ptr ErlNifEnv; a2: cstring;
    a3: ErlNifResourceFlags; a4: ptr ErlNifResourceFlags): untyped =
  enif_open_resource_type(a1, nil, a2, nil, a3, a4)
...
func enif_get_resource*(a1: ptr ErlNifEnv; a2: ErlNifTerm; a3: pointer;
    a4: pointer): bool {.c_dep_proc.}

# timeslice/scheduling
func enif_consume_timeslice*(a1: ptr ErlNifEnv; a2: cint): bool {.c_dep_proc.}
func enif_schedule_nif*(a1: ptr ErlNifEnv; a2: cstring; a3: ErlNifFlags;
    a4: ErlNifFptr; a5: cint; a6: ErlNifArgs): ErlNifTerm {.c_dep_proc.}
template enif_schedule_nif*(a1: ptr ErlNifEnv; a2: ErlNifFptr; a3: openArray[
    ErlNifTerm]): untyped =
  enif_schedule_nif(a1, astToStr(a2), ERL_NIF_REGULAR, a2, len(a3).cint, cast[
      ErlNifArgs](a3.unsafeAddr))

# exceptions
func enif_raise_exception*(a1: ptr ErlNifEnv; a2: ErlNifTerm): ErlNifTerm {.c_dep_proc.}
func enif_has_pending_exception*(a1: ptr ErlNifEnv; a2: ptr ErlNifTerm): bool {.
    c_dep_proc, minNifVersion(2, 8).}
...
func enif_monotonic_time*(a1: ErlNifTimeUnit): ErlNifTime {.c_dep_proc,
    minNifVersion(2, 10).}
func enif_convert_time_unit*(a1: ErlNifTime; a2: ErlNifTimeUnit;
    a3: ErlNifTimeUnit): ErlNifTime {.c_dep_proc, minNifVersion(2, 10).}
...
func enif_snprintf*(a1: pointer; a2: cuint; a3: cstring): cint {.varargs,
    c_dep_proc, minNifVersion(2, 11).}
