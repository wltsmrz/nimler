...
proc is_atom(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_int(env, cast[cint](enif_is_atom(env, argv[0])))

proc is_binary(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_int(env, cast[cint](enif_is_binary(env, argv[0])))

proc is_current_process_alive(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_int(env, cast[cint](enif_is_current_process_alive(env)))

proc is_empty_list(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_int(env, cast[cint](enif_is_empty_list(env, argv[0])))

proc is_exception(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_int(env, cast[cint](enif_is_exception(env, argv[0])))

proc is_fun(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_int(env, cast[cint](enif_is_fun(env, argv[0])))

proc is_identical(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_int(env, cast[cint](enif_is_identical(argv[0], argv[1])))

proc is_list(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_int(env, cast[cint](enif_is_list(env, argv[0])))

proc is_map(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_int(env, cast[cint](enif_is_map(env, argv[0])))

proc is_number(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_int(env, cast[cint](enif_is_number(env, argv[0])))

proc is_pid(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_int(env, cast[cint](enif_is_pid(env, argv[0])))

proc is_pid_undefined(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var pid: ErlNifPid
  discard enif_get_local_pid(env, argv[0], addr(pid))
  return enif_make_int(env, cast[cint](enif_is_pid_undefined(addr(pid))))

# proc is_port(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
#   return enif_make_int(env, cast[cint](enif_is_port(env, argv[0])))
# 
# proc is_port_alive(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
#   return enif_make_int(env, cast[cint](enif_is_port_alive(env, argv[0])))

proc is_process_alive(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var pid: ErlNifPid
  discard enif_get_local_pid(env, argv[0], addr(pid))
  return enif_make_int(env, cast[cint](enif_is_process_alive(env, addr(pid))))

proc is_ref(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_int(env, cast[cint](enif_is_ref(env, argv[0])))

proc is_tuple(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_int(env, cast[cint](enif_is_tuple(env, argv[0])))

proc get_atom(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  let atom_len = 4
...
proc get_atom_length(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var atom_len: cuint
...
proc get_string(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
...
proc get_int(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var v: cint
...
proc get_long(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var v: clong
...
proc get_int64(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var v: clonglong
...
proc get_uint(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var v: cuint
...
proc get_ulong(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var v: culong
...
proc get_uint64(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var v: culonglong
...
proc get_double(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var v: cdouble
...
proc get_list_length(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var list_len: cuint
...
proc get_list_cell(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var head: ErlNifTerm
  var tail: ErlNifTerm
...
proc get_map_size(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var map_size: csize
...
proc get_map_value(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
...
proc get_local_pid(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
...
proc make_map_put(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
...
proc make_map_remove(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  let new_map = enif_make_new_map(env)
  let k = enif_make_atom(env, cstring("a"))
  let v = enif_make_int(env, 1)
...
proc make_map_update(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  let new_map = enif_make_new_map(env)
  let k = enif_make_atom(env, cstring("a"))
  let v = enif_make_int(env, 1)
...
proc make_string(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_string(env, cstring("test"), ERL_NIF_LATIN1)

proc make_string_len(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_string_len(env, cstring("test"), 4, ERL_NIF_LATIN1)

proc make_tuple(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
...
proc make_int(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_int(env, cint(1))

proc make_long(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_long(env, clong(1))

proc make_int64(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_int64(env, clonglong(1))

proc make_uint(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_uint(env, cuint(1))

proc make_ulong(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_ulong(env, culong(1))

proc make_uint64(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_uint64(env, culonglong(1))

proc make_double(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_double(env, cdouble(1.1))

proc make_new_binary(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var term: ErlNifTerm
...
proc make_new_map(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_new_map(env)

proc make_map_from_arrays(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  let keys = [
...
proc make_atom(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_atom(env, cstring("test"))

proc make_existing_atom(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
...
proc make_existing_atom_len(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var existing_atom: ErlNifTerm
...
proc make_list(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
...
proc make_list_cell(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  let h = enif_make_int(env, cint(1))
  let t = enif_make_int(env, cint(2))

  return enif_make_list_cell(env, h, t)

proc make_list_from_array(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  let values = [
    enif_make_int(env, cint(1)),
    enif_make_int(env, cint(2))
  ]
...
proc make_reverse_list(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
...
proc make_copy(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  let v = enif_make_int(env, cint(1))
  let c = enif_make_copy(env, v)

  return c

proc make_pid(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var pid_term = ErlNifPid(pid: 0xBEEF)
  return enif_make_pid(env, addr(pid_term))

proc make_ref(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_ref(env)

proc make_resource(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  var res: pointer
  return enif_make_resource(env, addr(res))

proc make_unique_integer(env: ptr ErlNifEnv, argc: cint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
  return enif_make_unique_integer(env, ERL_NIF_UNIQUE_POSITIVE)

# proc make_sub_binary(env: ptr ErlNifEnv, argc: cuint, argv: ErlNifArgs): ErlNifTerm {.exportc.} =
