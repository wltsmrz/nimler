...
defmodule NimlerWrapper do
    ...
    def codec_options(_a, _b), do: raise "not implemented"
    ...
    def codec_list_int(_a), do: raise "not implemented"
    def codec_list_string(_a), do: raise "not implemented"
    def codec_tuple(_a), do: raise "not implemented"
    def codec_map(_a, _b, _c), do: raise "not implemented"
    def codec_result_ok(_a, _b), do: raise "not implemented"
    def codec_result_error(_a, _b), do: raise "not implemented"
end
