...
export_nifs("Elixir.NimlerWrapper", [
  to_nif("enif_compare", 2, compare),
  to_nif("enif_term_type", 6, term_type),
  to_nif("enif_system_info", 0, system_info),
  to_nif("enif_snprintf", 1, snprintf),
  to_nif("enif_raise_exception", 1, raise_exception),
  to_nif("enif_is_atom", 1, is_atom),
  to_nif("enif_is_binary", 1, is_binary),
  to_nif("enif_is_current_process_alive", 0, is_current_process_alive),
  to_nif("enif_is_empty_list", 1, is_empty_list),
  to_nif("enif_is_exception", 1, is_exception),
  to_nif("enif_is_fun", 1, is_fun),
  to_nif("enif_is_identical", 2, is_identical),
  to_nif("enif_is_list", 1, is_list),
  to_nif("enif_is_map", 1, is_map),
  to_nif("enif_is_number", 1, is_number),
  to_nif("enif_is_pid", 1, is_pid),
  to_nif("enif_is_pid_undefined", 1, is_pid_undefined),
  to_nif("enif_is_process_alive", 1, is_process_alive),
  to_nif("enif_is_ref", 1, is_ref),
  to_nif("enif_is_tuple", 1, is_tuple),
  to_nif("enif_get_atom", 1, get_atom),
  to_nif("enif_get_atom_length", 1, get_atom_length),
  to_nif("enif_get_string", 1, get_string),
  to_nif("enif_get_int", 1, get_int),
  to_nif("enif_get_long", 1, get_long),
  to_nif("enif_get_int64", 1, get_int64),
  to_nif("enif_get_uint", 1, get_uint),
  to_nif("enif_get_ulong", 1, get_ulong),
  to_nif("enif_get_uint64", 1, get_uint64),
  to_nif("enif_get_double", 1, get_double),
  to_nif("enif_get_tuple", 1, get_tuple),
  to_nif("enif_get_list_length", 1, get_list_length),
  to_nif("enif_get_list_cell", 1, get_list_cell),
  to_nif("enif_get_map_size", 1, get_map_size),
  to_nif("enif_get_map_value", 2, get_map_value),
  to_nif("enif_get_local_pid", 1, get_local_pid),
  to_nif("enif_make_map_put", 3, make_map_put),
  to_nif("enif_make_map_remove", 2, make_map_remove),
  to_nif("enif_make_map_update", 3, make_map_update),
  to_nif("enif_make_string", 0, make_string),
  to_nif("enif_make_string_len", 0, make_string_len),
  to_nif("enif_make_list", 0, make_list),
  to_nif("enif_make_list_cell", 0, make_list_cell),
  to_nif("enif_make_list_from_array", 0, make_list_from_array),
  to_nif("enif_make_reverse_list", 0, make_reverse_list),
  to_nif("enif_make_tuple", 0, make_tuple),
  to_nif("enif_make_tuple_from_array", 0, make_tuple_from_array),
  to_nif("enif_make_int", 0, make_int),
  to_nif("enif_make_long", 0, make_long),
  to_nif("enif_make_int64", 0, make_int64),
  to_nif("enif_make_uint", 0, make_uint),
  to_nif("enif_make_ulong", 0, make_ulong),
  to_nif("enif_make_uint64", 0, make_uint64),
  to_nif("enif_make_double", 0, make_double),
  to_nif("enif_make_new_binary", 0, make_new_binary),
  to_nif("enif_make_new_map", 0, make_new_map),
  to_nif("enif_make_map_from_arrays", 0, make_map_from_arrays),
  to_nif("enif_make_atom", 0, make_atom),
  to_nif("enif_make_existing_atom", 0, make_existing_atom),
  to_nif("enif_make_existing_atom_len", 0, make_existing_atom_len),
  to_nif("enif_make_copy", 0, make_copy),
  to_nif("enif_make_pid", 0, make_pid),
  to_nif("enif_make_ref", 0, make_ref),
  to_nif("enif_make_unique_integer", 0, make_unique_integer)
])
